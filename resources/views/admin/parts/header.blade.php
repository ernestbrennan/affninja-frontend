        ...
        <div class="collapse navbar-collapse" id="mobile-menu">
          <ul class="nav navbar-nav">
            ...
            <li v-for="item in menu" :class="['dropdown', item.href === location[0] ? 'active' : '']">
              <template v-if="_.get(item, 'childrens', []).length">
                ...
                <transition enter-active-class="slideInUp"
                  ...
                  <ul class="dropdown-menu">
                    <li v-for="child in item.childrens"
                      ...
                      <a v-if="child.id && item.href === location[0]"
                        ...
                        @{{ child.title }}
                        <navbar-counter v-if="child.count" :count="child.count"></navbar-counter>
                      </a>
          ...
          <li v-for="(item, index) in menu"
            ...
            <a @click="onClick($event, item)" :href="item.href">
              <span class="title">@{{ item.title }}
                <navbar-counter v-if="item.count" :count="item.count"></navbar-counter>
              </span>
