<script type="text/x-template" id="landings-tpl">
  <div class="hpanel">
    <div class="panel-heading hbuilt">
      ...
      <span class="panel-title">{{ trans('offers.landings') }}</span>
    </div>
    <div class="panel-body">
      <div class="row">
        <div v-show="list_type === 'grid'" class="col-xs-12">
          @include('publisher::offer.profile.components.landings_grid')
        </div>
        <div v-show="list_type === 'list'" class="col-xs-12">
          @include('publisher::offer.profile.components.landings_list')
        </div>
      </div>
    </div>
  </div>
