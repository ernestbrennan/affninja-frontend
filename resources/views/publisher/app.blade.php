...
@include('publisher::parts.header')
...
<script>
    USER_PERMISSIONS = {!!  json_encode(Session::get('user')['permissions']) !!};
</script>
<script src="/dist/vendor.js?{{ Config::get('app.version') }}"></script>
<script src="/publisher/dist/app.js?{{ Config::get('app.version') }}"></script>
<script src="/dist/components.js?{{ Config::get('app.version') }}"></script>
<script src="/publisher/navbar.js?{{ Config::get('app.version') }}"></script>
