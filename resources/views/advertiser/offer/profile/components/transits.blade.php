<script type="text/x-template" id="transits-tpl">
  <div class="hpanel">
    <div class="panel-heading hbuilt">
      ...
      <span class="panel-title m-l-xs">{{ trans('offers.transits') }}</span>
    </div>
    <div class="panel-body">
      <div class="row">
        <div v-show="list_type === 'grid'" class="col-xs-12">
          @include('advertiser::offer.profile.components.transits_grid')
        </div>
        <div v-show="list_type === 'list'" class="col-xs-12">
          @include('advertiser::offer.profile.components.transits_list')
        </div>
      </div>
    </div>
  </div>
