...
@include('advertiser::parts.header')
...
<script src="/affiliate/dist/app.js?{{ Config::get('app.version') }}"></script>
<script src="/dist/components.js?{{ Config::get('app.version') }}"></script>
<script src="/affiliate/navbar.js?{{ Config::get('app.version') }}"></script>
