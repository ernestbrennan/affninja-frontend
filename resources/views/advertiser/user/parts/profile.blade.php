              ...
              <div class="col-lg-5 col-md-6 col-sm-8 col-xs-12">
                ...
                <div class="form-group">
                  <label class="control-label" for="whatsapp">
                    {{ trans('messages.whatsapp') }}:
                  </label>
                  <input v-model="whatsapp" class="form-control" name="skype" id="whatsapp">
                </div>
                ...
                <div class="form-group">
                  <label class="control-label" for="interface_locale">{{ trans('users.settings_locale') }}:</label>
                  <select-item v-model="interface_locale"
                               :options="locale"
                               id="interface_locale"
