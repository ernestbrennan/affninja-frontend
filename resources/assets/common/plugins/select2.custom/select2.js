    ...
    function H(c) {
        ...
        return function (i) {
            window.clearTimeout(d), d = window.setTimeout(function () {
                var d = c.data, f = g, j = c.transport || a.fn.select2Custom.ajaxDefaults.transport, k = {
                    type: c.type || "GET",
                    cache: c.cache || !1,
                    jsonpCallback: c.jsonpCallback || b,
                    dataType: c.dataType || "json"
                }, l = a.extend({}, a.fn.select2Custom.ajaxDefaults.params, k);
        ...
        j = a(document), g = function () {
            ...
            bind: function (a) {
                ...
                a(document).on("click", function (a) {
                    a.stopPropagation(), j.dropdown.removeClass("select2-drop-active")
                }), c.alwaysOpened && this.open()
            }, destroy: function () {
                ...
                if (d = c.element, "select" === d.get(0).tagName.toLowerCase() && (this.select = e = c.element), e && a.each(["id", "multiple", "ajax", "query", "createSearchChoice", "initSelection", "data", "tags"], function () {
                    ...
                    }, a.fn.select2Custom.defaults, c), "function" != typeof c.id && (f = c.id, c.id = function (a) {
                        return a[f]
                ...
                return s ? (u = !0, !p && o && (v = !0, u = !1)) : (u = !1, !o && p && (v = !0, u = !0)), this.opts.alwaysOpened ? !1 : (v && (b.hide(), c = this.container.offset(), d = this.container.outerHeight(!1), e = this.container.outerWidth(!1), f = b.outerHeight(!1), j = g.scrollLeft() + h, l = g.scrollTop() + i, m = c.top + d, n = c.left, q = b.outerWidth(!1), r = j >= n + q, b.show()), this.opts.dropdownAutoWidth ? (x = a(".select2-results", b)[0], b.addClass("select2-drop-auto-width"), b.css("width", ""), q = b.outerWidth(!1) + (x.scrollHeight === x.clientHeight ? 0 : k.width), q > e ? e = q : q = e, r = j >= n + q) : this.container.removeClass("select2-drop-auto-width"), "static" !== this.body().css("position") && (t = this.body().offset(), m -= t.top, n -= t.left), r || (n = c.left + this.container.outerWidth(!1) - q), w = {
                    left: n,
                    width: e
                }, u && !this.opts.alwaysOpened ? (w.top = c.top - f, w.bottom = "auto", this.container.addClass("select2-drop-above"), b.addClass("select2-drop-above")) : (w.top = m, w.bottom = "auto", this.container.removeClass("select2-drop-above"), b.removeClass("select2-drop-above")), w = a.extend(w, L(this.opts.dropdownCss)), b.css(w), void 0)
            }, shouldOpen: function () {
                var b;
                ...
                this.container.addClass("select2-dropdown-open").addClass("select2-container-active"), this.clearDropdownAlignmentPreference(), this.dropdown[0] !== this.body().children().last()[0] && (this.opts.alwaysOpened ? this.dropdown.detach().appendTo(this.container.parent()) : this.dropdown.detach().appendTo(this.body())), f = a("#select2-drop-mask"), 0 == f.length && (f = a(document.createElement("div")), f.attr("id", "select2-drop-mask").attr("class", "select2-drop-mask"), f.hide(), f.appendTo(this.body()), f.on("mousedown touchstart click", function (b) {
                    n(f);
                ...
                })), this.dropdown.prev()[0] !== f[0] && this.dropdown.before(f), a("#select2-drop").removeAttr("id"), this.dropdown.attr("id", "select2-drop"), this.opts.alwaysOpened || f.show(), this.positionDropdown(), this.dropdown.show(), this.positionDropdown(), this.dropdown.addClass("select2-drop-active");
                var g = this;
                ...
                if (this.opened() && !this.opts.alwaysOpened) {
            ...
            createContainer: function () {
                ...
                if (d = b.data("select2-data")) {
                    ...
                    return b.remove(), this.opts.element.trigger({
                        ...
                        val: this.id(d),
                        choice: d
                    }), this.triggerChange({removed: d}), this.opts.alwaysOpened && this.updateResults(!0), !0
                }
            }, postprocessResults: function (a, b, c) {
            ...
            alwaysOpened: !1
        }, a.fn.select2Custom.ajaxDefaults = {
            transport: a.ajax,
