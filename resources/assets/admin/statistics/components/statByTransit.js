    ...
    methods: {
        getStat() {
            ...
            apiRequest('stat.getByTransit', 'GET', params, response => {
                ...
                renderTemplate(StatParameter.template_path + 'by_transit.hbs', tpl_data, '#handlebars_stat_tpl_wrap', {},
                    () => {
        ...
        getLeadLink(transit_hash = null, status = null) {

            let transit_hashes = is_null(transit_hash) ?
                _.get(this.filter_values, 'transit_hashes', [])
                : [transit_hash];
