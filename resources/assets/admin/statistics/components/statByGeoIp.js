Vue.component('by-geo-ip', {
    ...
    methods: {
            ...
            apiRequest('stat.getByRegion', 'GET', params, result => {
                ...
                if (result.response.length > 0) {
                    ...
                    for (row of result.response) {
                        ...
                        row.leads_link = this.getLeadLink(null, row.region_id);
                ...
                renderTemplate(StatParameter.template_path + 'by_region.hbs',
                    tpl_data,
            ...
            apiRequest('stat.getByCity', 'GET', params, result => {
                ...
                if (result.response.length > 0) {
                    ...
                    for (row of result.response) {
                        ...
                        row.leads_link = this.getLeadLink(null, null, row.city_id);
                ...
                renderTemplate(StatParameter.template_path + 'by_city.hbs',
                    tpl_data,
        ...
        getLeadLink(country_id = null, region_id = null, city_id = null, status = null) {
