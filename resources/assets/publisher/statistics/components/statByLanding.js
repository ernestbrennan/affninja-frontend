    ...
    methods: {
        getStat() {
            ...
            apiRequest('stat.getByLanding', 'GET', params, response => {
                ...
                renderTemplate(StatParameter.template_path + 'by_landing.hbs', tpl_data,
        ...
        getLeadLink(landing_hash = null) {
            let landing_hashes = is_null(landing_hash) ? _.get(this.filter_values, 'landing_hashes', []) : [landing_hash],
                params = {
